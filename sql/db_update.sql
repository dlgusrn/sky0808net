...
CREATE TABLE IF NOT EXISTS `preacher_list` (
	`idx` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `video_list` (
	`idx` INT NOT NULL AUTO_INCREMENT,
	`title` VARCHAR(30) NOT NULL DEFAULT '(제목 미지정)' COLLATE 'utf8mb4_unicode_ci',
	`preacher` VARCHAR(50) NOT NULL COMMENT '설교자' COLLATE 'utf8mb4_unicode_ci',
	`worship` VARCHAR(10) NOT NULL COMMENT '예배 종류' COLLATE 'utf8mb4_unicode_ci',
	`church` ENUM('sky','beer') NOT NULL DEFAULT 'sky' COMMENT '교회 종류' COLLATE 'utf8mb4_unicode_ci',
	`link` VARCHAR(50) NOT NULL COMMENT '유튜브 링크' COLLATE 'utf8mb4_unicode_ci',
	`date_update` DATETIME NULL DEFAULT NULL,
	`date_insert` DATETIME NOT NULL,
	PRIMARY KEY (`idx`) USING BTREE
)
COMMENT='등록된 다시보기 영상 목록'
COLLATE='utf8mb4_unicode_ci'
ENGINE=InnoDB
;

ALTER TABLE `member_admin` DROP COLUMN `member_admin`;
ALTER TABLE `member_admin` DROP COLUMN `member_saint`;